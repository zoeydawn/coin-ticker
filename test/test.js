...
describe('coinTicker', () => {
  ...
  it('Should return an object of Coinbase LTC/USD data', done => {
    coinTicker('coinbase', 'ltcusd').then(data => {
      expect(data).to.be.an('object');
      expect(data.rawData).to.be.an('object');
      expect(data).to.have.all.keys('last', 'ask', 'bid', 'low', 'high', 'vol', 'timestamp', 'exchange', 'pair', 'rawData');
      expect(data.last).to.be.a('string');
  ...
  it('Should return an object of Coinbase LTC/EUR data', done => {
    coinTicker('coinbase', 'ltceur').then(data => {
      expect(data).to.be.an('object');
      expect(data.rawData).to.be.an('object');
      expect(data).to.have.all.keys('last', 'ask', 'bid', 'low', 'high', 'vol', 'timestamp', 'exchange', 'pair', 'rawData');
      expect(data.last).to.be.a('string');
